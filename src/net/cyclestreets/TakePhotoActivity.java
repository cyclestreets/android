...
//		// build layout
//		surface = (SurfaceView) findViewById(R.id.takephoto_surface);
//		setContentView(R.layout.takephoto);
        ...
        rl.addView(surface, new RelativeLayout.LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.FILL_PARENT));
        setContentView(rl);
	}
