...
public class ApiClient {
	...
	static public String callApiRaw(final String path, String... args) throws Exception
	{
	...
	static public <T> T postApi(final Class<T> returnClass, final String path, Object... args) 
		throws Exception 
	{
